      ...
      >
        ...
        <Box width="clamp(20%, 25%, 30%)">
          ...
          <Typography color={"white"} mb="30px">
            Address: 356 P. Casal St Quiapo Manila
          </Typography>
          <Typography color={"white"} mb="30px" sx={{ wordWrap: "break-word" }}>
            Email: jeffreelingal0000@gmail.com
          </Typography>
          <Typography color={"white"} mb="30px">Contact Number: 09669339001</Typography>
          <Typography color={"white"} mb="30px">Developed By: Jeffree Lingal</Typography>
        </Box>
      </Box>
    </Box>
  );
